...
if (mysqli_num_rows($existingDataResult) > 0) {
  ...
  <tbody> ";
    ...
    $d1_result = mysqli_query($conn, $d1_query);
    ...
    $query_limit = "SELECT * FROM expense WHERE user_id = $user_id AND date BETWEEN '$start_date1' AND '$end_date1' ORDER BY id DESC LIMIT $offset, $limit";
  ...
  <table id='tbl'>
    ...
    $query_limit1 = "SELECT * FROM income WHERE user_Id = $user_id AND date BETWEEN '$start_date1' AND '$end_date1' ORDER BY ID DESC LIMIT $offset1,$limit1";
 ...
 <ul class='pagination>'";
  ...
  // <!-- =============================SSSEARCHHHHHHHHHHHHHHHHHHHH========================================================================== -->
    ...
    if ($sql = "SELECT * FROM expense WHERE user_id = $user_id AND category='$search' OR user_id = $user_id AND date = '$search' AND date BETWEEN '$start_date1' AND '$end_date1'") {
      // echo "Search";
   ...
   <table id='tbl'>
    ...
    <tbody> ";
      ...
      if ($expenseTotal2 = mysqli_num_rows($result)) {
        ...
        $query_limit2 = "SELECT * FROM expense WHERE user_id = $user_id AND category='$search' OR user_id = $user_id AND date = '$search' AND date BETWEEN '$start_date1' AND '$end_date1' ORDER BY id DESC LIMIT $offset2,$limit2";
  ...
  ";
    ...
    // ========================================================================================================
    if ($sql3 = "SELECT * FROM income WHERE  user_ID = $user_id AND category='$search' OR user_ID = $user_id AND date = '$search' AND date BETWEEN '$start_date1' AND '$end_date1' ") {
    ...
    <table id='tbl'>
      ...
      if ($incomeTotal3 = mysqli_num_rows($result3)) {
        ...
        $query_limit3 = "SELECT * FROM income WHERE user_ID = $user_id AND  category='$search' OR user_ID = $user_id AND date = '$search' AND date BETWEEN '$start_date1' AND '$end_date1' ORDER BY ID DESC LIMIT $offset3,$limit3";
